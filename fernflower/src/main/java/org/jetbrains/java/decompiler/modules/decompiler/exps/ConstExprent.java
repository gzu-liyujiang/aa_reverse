  ...
  public TextBuffer toJava(int indent, BytecodeMappingTracer tracer) {
    ...
    switch (constType.type) {
      ...
      case CodeConstants.TYPE_INT:
        ...
        return new TextBuffer(String.format((String)DecompilerContext.getProperty(IFernflowerPreferences.INT_FORMAT),value));
      ...
      case CodeConstants.TYPE_LONG:
        ...
        return new TextBuffer(String.format((String)DecompilerContext.getProperty(IFernflowerPreferences.INT_FORMAT),value)+'L');
