...
public class StructExceptionsAttribute extends StructGeneralAttribute {
  ...
  public String getExcClassname(int index, ConstantPool pool) {
      android.util.Log.w("AA逆向助手:Fernflower","ex "+throwsExceptions.get(index).intValue());
      //android.util.Log.w("AA逆向助手:Fernflower","ex "+pool.getPrimitiveConstant(throwsExceptions.get(index).intValue()-1).getString());
      if(pool==null) android.util.Log.w("AA逆向助手:Fernflower","pool is null!");
