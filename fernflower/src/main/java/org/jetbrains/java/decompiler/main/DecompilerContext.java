...
public class DecompilerContext {
  ...
  //private SyntheticCollector syntheticCollector;
 ...
 /* public static SyntheticCollector getSyntheticCollector(){
    return getCurrentContext().syntheticCollector;
  }
    
  public static void setSyntheticCollector(SyntheticCollector syntheticCollector){
    getCurrentContext().syntheticCollector=syntheticCollector;
  }
    */
