...
public class TypeGen {
    ...
    public static String literalToString(long literal,ArgType type){
        return literalToString(literal,type,new StringUtils());
    }

    public static String formatByte(Byte val){
        return formatByte(JadxPreferences.Option_GetStr(JadxPreferences.OPT_INT_FORMAT),val);
    }

    public static String formatShort(Short val){
        return formatShort(JadxPreferences.Option_GetStr(JadxPreferences.OPT_INT_FORMAT),val);
    }

    public static String formatLong(Long val){
        return formatLong(JadxPreferences.Option_GetStr(JadxPreferences.OPT_INT_FORMAT),val);
    }

    public static String formatInteger(Integer val){
        return formatInteger(JadxPreferences.Option_GetStr(JadxPreferences.OPT_INT_FORMAT),val);
    }
	...
	private static String literalToString(long lit, ArgType type,StringUtils stringUtils) {
		...
		switch (type.getPrimitiveType()) {
			...
			case BYTE:
				return formatByte(JadxPreferences.Option_GetStr(JadxPreferences.OPT_INT_FORMAT),(byte) lit);
			case SHORT:
				return formatShort(JadxPreferences.Option_GetStr(JadxPreferences.OPT_INT_FORMAT),(short) lit);
			case INT:
				return formatInteger(JadxPreferences.Option_GetStr(JadxPreferences.OPT_INT_FORMAT),(int) lit);
			case LONG:
				return formatLong(JadxPreferences.Option_GetStr(JadxPreferences.OPT_INT_FORMAT),lit);
			case FLOAT:
	...
	public static String formatShort(String format,short s) {
		...
		return "(short) " + String.format(format,s);
	}

	public static String formatByte(String format,byte b) {
		if (b == Byte.MAX_VALUE) {
		...
		return "(byte) " + String.format(format,b);
	}

	public static String formatInteger(String format,int i) {
	...
	public static String formatLong(String format,long l) {
		if (l == Long.MAX_VALUE) {
		...
		return String.format(format,l)+"L";
	}
