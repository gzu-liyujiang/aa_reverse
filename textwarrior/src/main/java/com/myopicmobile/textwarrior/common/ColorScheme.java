	...
	public int getTokenColor(int tokenType)
	{
		...
		switch (tokenType)
		{
			...
			case ILexer.NAME:
				...
				break;
			case ILexer.DOUBLE_SYMBOL_LINE: //fall-through
			case ILexer.DOUBLE_SYMBOL_DELIMITED_MULTILINE:
			//case Lexer.SINGLE_SYMBOL_LINE_B:
				element = Colorable.COMMENT;
				break;
			case ILexer.SINGLE_SYMBOL_DELIMITED_A: //fall-through
			case ILexer.SINGLE_SYMBOL_DELIMITED_B:
				element = Colorable.STRING;
				break;
			case ILexer.NUMBER:
				element = Colorable.NUMBER;
				break;
			case ILexer.SINGLE_SYMBOL_LINE_A: //fall-through
			case ILexer.SINGLE_SYMBOL_WORD:
			case ILexer.OPERATOR:
				element = Colorable.SECONDARY;
				break;
			case ILexer.SINGLE_SYMBOL_LINE_B: //类型
				element=Colorable.NAME;
				break;
            case ILexer.ERROR:
            case ILexer.WARNING:
